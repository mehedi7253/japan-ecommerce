<template>
  <div>
    ...
    <section>
      <div class="container">
        <h3 class="section-heading">{{ $lang["Special Collection"] }}</h3>
        <div class="row mb-3">
            <div class="col-md-4 col-sm-12 float-left">
              <router-link to="/category/snacks">
                <img :src="'/uploads/media/snack-banner.webp'" class="img-fluid">
              </router-link>
            </div>
           <div class="col-md-4 col-sm-12 float-left">
              <router-link to="/category/beauty-health">
                <img :src="'/uploads/media/snack-banner.webp'" class="img-fluid">
              </router-link>
            </div>
             <div class="col-md-4 col-sm-12 float-left">
              <router-link to="/category/fruits-vegetabels">
                <img :src="'/uploads/media/snack-banner.webp'" class="img-fluid">
              </router-link>
            </div>
        </div>
    ...
    <section v-if="products.length > 0" class="popular-items section">
      <div class="container">
        <h3 class="section-heading">{{ $lang["NEW ARRIVALS"] }}</h3>
        <div id="slider">
          <Products
            :products="products"
            productType="offer"
   ...
   <section>
      <div class="container">
        <h3 class="section-heading">Special Collections</h3>
        <div class="row mb-3">
            <div class="col-md-4 col-sm-12 float-left">
              <router-link to="/category/snacks">
                <img :src="'/uploads/media/snack-banner.webp'" class="img-fluid">
